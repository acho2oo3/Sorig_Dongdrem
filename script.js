...
function checkOrder(branchColors, treeIndex, branchIndex) {
  const expectedOrders = [
    ...
    [["grey"], ["orange"], ["black"]], // For the second tree
    [
      [
        "grey",
        "grey",
        ...
        "grey",
        "grey",
      ], // First branch of the third tree
      ["orange", "orange", "orange", "orange", "orange", "orange", "orange"], // Second branch of the third tree
      [
        "black",
        "black",
        "black",
        ...
        "black",
        "black",
      ], // Third branch of the third tree
    ],
  ];
